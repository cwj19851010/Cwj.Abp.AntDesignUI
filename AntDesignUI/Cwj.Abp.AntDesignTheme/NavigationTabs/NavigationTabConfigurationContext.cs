...
public class NavigationTabConfigurationContext : INavigationTabConfigurationContext
{
    ...
    public NavigationTabConfigurationContext(IServiceProvider serviceProvider)
    {
